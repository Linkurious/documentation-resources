...
helm pull oci://709825985650.dkr.ecr.us-east-1.amazonaws.com/linkurious/ogma-hourly --version 0.2.6
...
```sh
docker pull 709825985650.dkr.ecr.us-east-1.amazonaws.com/linkurious/ogma-hourly-container:5.0.8-rc4
```
...
```sh
docker run --rm -p8080:8080 709825985650.dkr.ecr.us-east-1.amazonaws.com/linkurious/ogma-hourly-container:5.0.8-rc4
```
...
```sh
docker run --rm -p8080:8080 -v ./htpasswd:/etc/nginx/htpasswd-conf/htpasswd 709825985650.dkr.ecr.us-east-1.amazonaws.com/linkurious/ogma-hourly-container:5.0.8-rc4
```
